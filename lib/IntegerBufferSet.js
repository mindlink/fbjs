...
var IntegerBufferSet = function () {
  ...
  IntegerBufferSet.prototype.getSize = function getSize() /*number*/{
    return this._size;
  };

  IntegerBufferSet.prototype.getValuePosition = function getValuePosition( /*number*/value) /*?number*/{
  ...
  IntegerBufferSet.prototype.getNewPositionForValue = function getNewPositionForValue( /*number*/value) /*number*/{
  ...
  IntegerBufferSet.prototype.replaceFurthestValuePosition = function replaceFurthestValuePosition(
  /*number*/lowValue,
  /*number*/highValue,
  ...
  IntegerBufferSet.prototype._pushToHeaps = function _pushToHeaps( /*number*/position, /*number*/value) {
    var element = {
      position: position,
      value: value
    };
  ...
  IntegerBufferSet.prototype._cleanHeaps = function _cleanHeaps() {
  ...
  IntegerBufferSet.prototype._recreateHeaps = function _recreateHeaps() {
  ...
  IntegerBufferSet.prototype._cleanHeap = function _cleanHeap( /*object*/heap) {
    while (!heap.empty() && this._valueToPositionMap[heap.peek().value] === undefined) {
      heap.pop();
    }
  };

  IntegerBufferSet.prototype._smallerComparator = function _smallerComparator( /*object*/lhs, /*object*/rhs) /*boolean*/{
    return lhs.value < rhs.value;
  };

  IntegerBufferSet.prototype._greaterComparator = function _greaterComparator( /*object*/lhs, /*object*/rhs) /*boolean*/{
    return lhs.value > rhs.value;
  };
